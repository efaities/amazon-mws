...
class MWSClient{
   ...
   /**
     ...
     * @param array $orders an array containing the orders with AmazonOrderID, idPedido, CarrierName and ShipperTrackingNumber
     * @return array feed submission result
     */
    public function updateFulfillment(array $orders) {
